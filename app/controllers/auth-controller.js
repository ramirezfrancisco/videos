...
//Requerimos el paquete de nodomailer
    ...
    signInPost(request, response, next){
        ...
        authModel.setUser(user, (error) => {
            if(!error){
                ...
                //response.window.alert("Se envio mensaje de verificacion");
        var transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
            user: 'ramirezlpez034@gmail.com',
            pass: 'ramirezluis'
            }
        });
        ...
        var mailOptions = {
            from: 'ramirezlpez034@gmail.com',
            to: request.body.email,
            subject: 'verifique',
            text: mensaje,
            html:  '<a href="http://localhost:8080">videos</a>'
        };
